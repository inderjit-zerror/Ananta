...
const data = [
  {
    ...
    para1:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima dolorem veritatis sed nesciunt maxime. Id obcaecati deleniti eligendi atque sequi!",
    para2:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima dolorem veritatis sed nesciunt maxime. Id obcaecati deleniti eligendi atque sequi!",
    ...
    <div>
      <div className="w-full  pb-20 px-[40px] bg-[#F5F3EA] relative z-90 py-[100px] max-sm:py-[80px] max-sm:px-[20px] max-sm:h-fit max-sm:overflow-x-hidden max-sm:px-[10px] max-sm:pb-[20px]">
          ...
          {data.map((item, i) => {
            return (
              <div
                ...
                key={i}
                className={`CFF cursor-pointer capitalize relative text-lg flex justify-center max-sm:justify-start max-sm:border-b border-black/30 pb-[5px] ${
                  activeAmentie.id === item.id ? "opacity-100" : "opacity-50"
                }  `}
              >
        ...
        <div className="w-full mt-20 relative flex items-end  justify-between max-sm:h-fit  max-sm:flex-col max-sm:mt-[0px]   ">
          <div className=" small_img_1 w-[28vw] absolute bg-[#F5F3EA] top-0 max-sm:top-[5%] left-[15vw] aspect-[4/3] p-10  max-sm:w-[70vw] max-sm:left-[-3%] max-sm:h-[300px] max-sm:p-[10px]">
            <div className="w-full h-full overflow-hidden">
              <img
                className="w-full h-full object-cover"
                src={activeAmentie.smallImg1}
                alt=""
              />
            </div>
          </div>
