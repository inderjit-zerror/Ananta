...
const MenuComponent = ({ navStatus, SetNavStatus }) => {
  ...
  return (
    <div className="MenuMainCont w-full h-[100dvh] fixed top-[0%] gap-[30px] left-[0%] z-[98] bg-[#F5F3EA] flex flex-col justify-center items-center overflow-hidden">
