...
const CraftedSection = () => {
  ...
  return (
    <>
      <div id="About" className="Crafted_Cont w-full min-h-screen relative overflow-hidden flex flex-col max-sm:px-[20px]  p-[40px] max-sm:p-[10px] gap-y-32 max-sm:gap-[45px] py-[100px] bg-[#FEF7EE] z-90">
        ...
        <div className="w-full h-fit flex text-white  justify-between items-end max-sm:flex-col max-sm:mt-[30px]">
          ...
          <div className="w-[50%] max-w-[500px]  h-full flex STF items-center  md:pr-[40px] max-sm:w-full max-sm:max-w-full max-sm:mt-[50px]">
            <div className="text-[20px] leading-[22px] max-sm:text-[20px] STF max-sm:leading-[22px] text-justify  ">
              ...
              <p className="mt-[20px]">Together, they shape a residence that stands as a benchmark of refined craftsmanship.</p>
        ...
        <div className="flex my-[100px] max-sm:my-[20px]   flex-col md:flex-row items-center relative gap-10 md:gap-16 max-sm:gap-[5px] max-w-6xl mx-auto max-sm:w-full">
          ...
          <div className="flex gap-4 items-end">
            {/* Image 1 */}
            <div onMouseEnter={()=>HoverImageActivate('.ch1')} onMouseLeave={()=>HoverImageDeActivate('.ch1')} className="w-[250px] h-[300px] ImgP1 md:w-[250px] md:h-[300px] overflow-hidden  cursor-pointer max-sm:w-[50%] max-sm:h-[200px] ">
              <Image
            ...
            {/* Image 2 */}
            <div onMouseEnter={()=>HoverImageActivate('.ch2')} onMouseLeave={()=>HoverImageDeActivate('.ch2')} className="w-[250px] h-[330px] ImgP2 md:w-[320px] md:h-[430px] overflow-hidden  cursor-pointer max-sm:w-[50%] max-sm:h-[250px] ">
              <Image
                src="/Img/Crafted/TMBG1.webp"
                width={1000}
                height={1000}
        ...
        <div className="flex flex-col gap-8 text-white md:w-1/2 px-[10px]">
          ...
          {/* Heading */}
          <h1 className="text-4xl CFF md:text-6xl  flex">
            Elite Developers
          </h1>
          ...
          <div className="grid grid-cols-2 gap-10 mt-6">
            ...
            {/* Stat 2 */}
            <div className="flex w-fit h-fit flex-col gap-[20px] max-sm:gap-[10px]">
              <h2 className="text-[3rem] max-sm:text-[30px] CFF">1.5M+ Sq. Ft</h2>
              <p className="text-[20px] mt-1 leading-[22px] STF max-sm:text-[14px] max-sm:leading-[15px]">
        ...
        <div className="flex flex-col  text-white md:w-1/2 pr-[50px]  max-sm:pr-[10px]  mt-[30px] max-sm:w-full max-sm:items-center  max-sm:pb-[50px]">
          ...
          {/* Right Image */}
          <div onMouseEnter={()=>HoverImageActivate('.ch3')} onMouseLeave={()=>HoverImageDeActivate('.ch3')} className="w-full max-w-[350px] ImgP3 h-[350px] md:h-[350px] max-sm:h-[444px] overflow-hidden rounded-sm ml-auto max-sm:ml-0 cursor-pointer  max-sm:w-full">
            <Image
